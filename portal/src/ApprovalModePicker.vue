...
<template>
  <div ref="root" class="relative min-w-0 max-w-44">
    ...
    <div
      ...
      class="fixed inset-x-2 bottom-2 [z-index:var(--app-studio-z-dropdown)] max-h-[calc(100dvh-1rem)] overflow-y-auto rounded-xl border border-border-default bg-surface-overlay p-1.5 shadow-xl md:absolute md:inset-x-auto md:bottom-9 md:left-0 md:max-h-[min(28rem,calc(100dvh-7rem))] md:w-[360px]"
    >
      ...
      <button
        ...
        class="app-studio-touch-target flex w-full items-start gap-2 rounded-md px-1.5 py-1.5 text-left transition hover:bg-surface-hover"
